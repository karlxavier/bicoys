...
OrderStatus.create(OStatus: "New")
OrderStatus.create(OStatus: "Checkout Confirm")
OrderStatus.create(OStatus: "Prepare")
OrderStatus.create(OStatus: "Ready")
OrderStatus.create(OStatus: "On d Way")
OrderStatus.create(OStatus: "Completed")
OrderStatus.create(OStatus: "Cancelled")
OrderStatus.create(OStatus: "Refunded")
OrderStatus.create(OStatus: "Bogus")

PaymentType.create(PType: "Cash on Delivery")
PaymentType.create(PType: "Credit Card")

RestaurantType.create(RType: "Restaurant")
RestaurantType.create(RType: "Bakery")
RestaurantType.create(RType: "Catering")
